...
class SimpleMNetV2Cls(nn.Module):

    def __init__(self, width_mult=1., last_channel=1280, classify_num=4, pool_pad=4):
        super().__init__()
        ...
        self.cls = nn.Linear(128, classify_num)
